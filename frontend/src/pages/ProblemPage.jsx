 ...
 useEffect(() => {
    const fetchProblem = async () => {
      ...
      try {
        ...
        // Handle missing startCode safely
        if (response.data.startCode && response.data.startCode.length > 0) {
          const startCodeEntry = response.data.startCode.find(sc => sc.language === langMap[selectedLanguage]);
          const initialCode = startCodeEntry?.initialCode || '// No starter code available';
          setCode(initialCode);
        } else {
